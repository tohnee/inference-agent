...
这个 skill 是 `cuda-kernel-opt-skill/skills/cuda-optimized-skill` 的统一主入口，用来把现有能力串成闭环：
...
优先复用以下内容，不要重写已有逻辑：
- benchmark: `cuda-kernel-opt-skill/skills/cuda-optimized-skill/kernel-benchmark/scripts/benchmark.py`
- benchmark skill 约定: `cuda-kernel-opt-skill/skills/cuda-optimized-skill/kernel-benchmark/SKILL.md`
- NCU 分析约定: `cuda-kernel-opt-skill/skills/cuda-optimized-skill/ncu-rep-analyze/SKILL.md`

优化知识库按后端选择：
- CUDA:
  - `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cuda/optim.md`
  - `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cuda/memory-optim.md`
  - `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cuda/compute-optim.md`
  - `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cuda/sync-optim.md`
- CUTLASS:
  - `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cutlass/cutlass-optim.md`
- Triton:
  - `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/triton/triton-optim.md`
...
#### CUDA
优先顺序：
1. 先从 `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cuda/optim.md` 获取整体迭代思路。
...
#### CUTLASS
优先从 `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/cutlass/cutlass-optim.md` 选取与问题形态匹配的方向，例如：
- Tensor Core 路径选择
...
#### Triton
优先从 `cuda-kernel-opt-skill/skills/cuda-optimized-skill/reference/triton/triton-optim.md` 选取高收益通用项，例如：
...
```bash
python cuda-kernel-opt-skill/skills/cuda-optimized-skill/operator-optimize-loop/scripts/optimize_loop.py <kernel.cu> \
...
```bash
python cuda-kernel-opt-skill/skills/cuda-optimized-skill/operator-optimize-loop/scripts/optimize_loop.py <kernel.py> \
...
```bash
python cuda-kernel-opt-skill/skills/cuda-optimized-skill/operator-optimize-loop/scripts/optimize_loop.py <next_version_file> \
...
```bash
python cuda-kernel-opt-skill/skills/cuda-optimized-skill/operator-optimize-loop/scripts/optimize_loop.py <solution_file> \
...
- 全局记忆：`cuda-kernel-opt-skill/skills/cuda-optimized-skill/operator-optimize-loop/strategy-memory/global_strategy_memory.json`
